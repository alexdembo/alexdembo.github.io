...
jQuery(document).ready(function(){
    ...
    $( "#lang-en" ).click(function() {
        $( "#1" ).text('Original recipes');
        $( "#2" ).text('Delicious');
        $( "#3" ).text('Top quality');
        $( "#4" ).text('Menu');
        $( "#5" ).text('Main courses');
        $( "#6" ).text('Burgers');
        $( "#7" ).text('Classic beef burger;');
        $( "#8" ).text('Beef burger with caramelised onion, mushrooms and Blu cheese');
        $( "#9" ).text('Beef burger with crunchy bacon and egg');
        $( "#10" ).text('Armenian shish kebab');
        $( "#11" ).text('Chicken shish kebab in hot sauce (baked on coals)');
        $( "#12" ).text('Chicken shish kebab sauced in fresh yogurt (baked on coals)');
        $( "#13" ).text('Pork neck shish kebab in sauced in yogurt (baked on coals)');
        $( "#14" ).text('Classic pork shish kebab (baked on coals)');
        $( "#15" ).text('Hot-dog');
        $( "#16" ).text('Chicken kebab with fresh vegetables');
        $( "#17" ).text('Side dishes');
        $( "#18" ).text('Potato dishes');
        $( "#19" ).text('French fries');
        $( "#20" ).text('Potato wedges (fried)');
        $( "#21" ).text('Cold snacks');
        $( "#22" ).text('Salads');
        $( "#23" ).text('Fresh cabbage salad');
        $( "#24" ).text('Beetroot and cheese salad');
        $( "#25" ).text('Sauces');
        $( "#26" ).text('Mayo');
        $( "#27" ).text('Ketchup');
        $( "#28" ).text('BBQ sauce');
        $( "#29" ).text('Mustard');
        $( "#30" ).text('Sweet chili sauce');
        $( "#31" ).text('Beer and refreshing drinks');
        $( "#32" ).text('Have questions? Get in touch!');
